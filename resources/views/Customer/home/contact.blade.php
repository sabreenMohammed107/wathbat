			...
			<div class="col-lg-6">
				<div class="col-md-12">
					<div class="footer-item">
						<ul>
							<li>
								<h6 style="margin:0px"><i class="fas fa-home" style="font-size:25px;color:#4169E1"></i> {{ __('titles.wathbet') }}</h6>
								<p style="margin:0px">here is a moment in the life of any aspiring a moment in the life., {{$branch->address}}</p>
							</li>
							<li>
								<h6 style="margin:0px"><i class="fas fa-envelope" style="font-size:25px;color:#4169E1"></i> {{ __('titles.email') }}</h6>
								<p style="margin:0px">{{$branch->email}}</p>
							</li>
							<li>
								<h6 style="margin:0px"><i class="fas fa-phone-alt" style="font-size:25px;color:#4169E1"></i> {{ __('titles.phone') }}</h6>
								<p style="margin:0px">{{$branch->phone}}</p>
							</li>
						</ul>
					</div>
				</div>
